...
const PickerFinance = (props: PickerFinanceInterface) => {
  return (
    ...
    >
      <Text style={[styles.whiteColor, styles.boldText]}>Cuotas</Text>
      <Picker
...
const CardView = (props: CardViewInterface) => {
  ...
  return (
    ...
    >
      <Image source={require("_assets/images/yellow.png")} />
      <View
        style={{
          paddingLeft: 10,
        }}
      >
        <Text style={[styles.boldText, styles.titleText, { color: isCardSelected ? "white" : "black" }]}>
          {props.cardInformation.type.charAt(0) + props.cardInformation.type.slice(1).toLowerCase()}
        </Text>
      ...
      <Modal animationType="slide" transparent={true} visible={props.modalVisible}>
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Text style={[styles.whiteColor, styles.boldText, { paddingVertical: 10 }]}>Escoje una tarjeta</Text>
            <View style={{}}>
            ...
            <TouchableOpacity style={styles.closeButton} onPress={handleFinance}>
              <Text style={styles.whiteColor}>Aceptar</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <TouchableOpacity style={styles.closeButton} onPress={() => props.setModalVisible(false)}>
              <Text style={styles.whiteColor}>Cerrar</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
...
export { ModalFinance, SearchModal };
