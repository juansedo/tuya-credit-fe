...
const SimulationTabScreen = (props: SearchScreenProps) => {
  let data = [
    ...
    },
    {
      ...
      ref: "Iphone SE 3",
      image_url:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRO9KRSvPS3mef6EX3yJ5MVf4MGIKAj0ZW0bEdSfYSqZEvXHfOm5Fxj74bCtcmgyN7xB9I&usqp=CAU",
    ...
    },
    {
      ...
      ref: "HH-09227001SS",
      image_url:
        "https://jumbocolombiafood.vteximg.com.br/arquivos/ids/3713486-512-512/813966029738-3.jpg?v=637550948431670000",
      description:
        "Con la Freidora de Aire Digital con Doble Canasta de 7.6L puedes cocinar dos recetas independientes al mismo tiempo. Su funcionalidad 8 en 1 te permite: asar, hornear, freír, rostizar, deshidratar, dorar, precalentar y hacer papas fritas.",
      value: "799900",
    ...
    },
    {
      ...
      ref: "198280",
      image_url:
        "https://exitocol.vtexassets.com/arquivos/ids/8203693/JEAN-LEVIS-198280-1731720_c.jpg?v=637598478146100000",
      description:
        "Este es el clásico y original pantalón de mezclilla. Este par viene elaborado con mezclilla premium selvedge, la cual proviene del borde del rollo del que se fabrican los jeans, por lo que le brinda un estilo único y exclusivo",
      value: "209900",
    ...
    },
    {
      ...
      description:
        "Diseño delgado y ultra portable para mantenerte conectado y con todas las tareas bajo control. Con batería duradera y pantalla de borde delgado la HP Laptop es tu compañera perfecta",
      value: "3099000",
    ...
    },
    {
      ...
      image_url:
        "https://exitocol.vtexassets.com/arquivos/ids/4945914-800-auto?v=637405271692830000&width=800&height=auto&aspect=true",
    ...
    },
    {
      ...
      ref: "SE 3",
      image_url:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSk2YSbkWwj-nBZ1K24YAaqn0Wf6ZQZo-RdNQwhQk55Gxc-v0Mm7abCU57mmIYEMe8rBFA&usqp=CAU",
    ...
    },
    {
      ...
      image_url:
        "https://carulla.vtexassets.com/arquivos/ids/6665950-800-auto?v=637742886286100000&width=800&height=auto&aspect=true",
    ...
    },
    {
      ...
      image_url:
        "https://olimpica.vtexassets.com/arquivos/ids/474490/Televisor-LED-FHD-OLIMPO-Smartv-101CM-40--40D3200S.jpg?v=637497819260800000",
